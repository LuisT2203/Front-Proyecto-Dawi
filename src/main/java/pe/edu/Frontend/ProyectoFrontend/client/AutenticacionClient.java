...
@FeignClient(name = "autenticacion-client", url = "https://backenddawwii-epcqhzhdbeaqhtez.canadacentral-01.azurewebsites.net/autenticar", configuration = FeignClientConfig.class)
